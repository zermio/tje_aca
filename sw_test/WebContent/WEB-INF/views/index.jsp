	...
	<div id="Form1" class="wrap">
        <div id="wrap" class="frm">
			...
			style="margin-bottom:15px;">
				...
				<div class="btn-group" role="group">
					<a class="btn btn-default" href='<c:url value="/devNote.do"/>' target="demoFrame" > 페이지 정보</a>
				</div>
			</div>
						...
						<div class="btn_bottom">
							<div class="btn_bottom_right">
								...
								<c:choose>
									...
									<c:otherwise>
										<a href='<c:url value="/member/goLogin.do"/>'>
				...
				<tr>
                	<td style="vertical-align: top;width:250px;">
						<div class="panel-group" id="accordion">
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title">
										<a data-toggle="collapse" data-parent="#accordion" href="#collapse1">게시판 메뉴</a>
									</h4>
								</div>
								<div id="collapse1" class="panel-collapse collapse in">
									<div class="panel-body">
										<div class="examples list-group">
											...
											<a href='<c:url value="/anything.do"/>' class="list-group-item" target="demoFrame">
												자유게시판(그리드)
											</a>
										</div>
									</div>
							...
							<c:if test="${sessionScope.userType==9 }">
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title">
										<a data-toggle="collapse" data-parent="#accordion" href="#collapse2">회원관리</a>
									</h4>
								</div>
								<div id="collapse2" class="panel-collapse collapse">
									<div class="panel-body">
										<div class="examples list-group">
											<a href='<c:url value="/something.do"/>' class="list-group-item" target="demoFrame">
												회원관리
											</a>

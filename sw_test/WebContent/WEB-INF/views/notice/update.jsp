	...
	<div id="wrap">
		...
		<div id="container">
			...
			<div id="content">
				...
				<!-- title board write -->
				<div class="title_board_write">공지 수정</div>
				<!-- //title board write -->
										...
										<tr>
											<th class="tcenter">첨부파일${vs.count}</th>
												<td colspan="3" style="text-align: left">
													...
													<a href="<c:url value="/notice/deleteAttach.do?fileIdx=${file.file_idx}&typeSeq=1&boardSeq=${board.boardSeq}"/>">

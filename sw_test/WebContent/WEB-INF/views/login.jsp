	...
	<div class="form">
		...
		<div class="form-panel one">
			...
			<div class="form-content">
				<form action="/sw/member/login.do" method="post">
					...
					<div class="form-group">
						<button type="button" onclick="location.href='/sw/index.do'">Home</button>
					</div>
				</form>
			</div>
		</div>
			...
			<div class="form-content">
				<form name="joinForm">
					...
					<div class="form-group">
						...
						<input type="password" id="" name="upc" required="required" />
					</div>
					<div class="form-group">
